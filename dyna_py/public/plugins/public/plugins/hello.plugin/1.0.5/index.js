...
// public/plugins/hello.plugin/1.0.5/compiled.js
...
// public/plugins/hello.plugin/1.0.5/entry.js
var entry_default = PluginRoot;
function mountPlugin(target, props = {}) {
  return mount(PluginRoot, { target, props });
}
export {
